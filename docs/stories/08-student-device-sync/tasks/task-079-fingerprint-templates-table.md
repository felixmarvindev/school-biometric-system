...
1. [ ] New model `FingerprintTemplate`:
...
3. [ ] On enrollment completion: insert into fingerprint_templates (in addition to or instead of enrollment_sessions.template_data)
4. [ ] Repository: create, get_by_student, get_by_student_and_finger
5. [ ] Enrollment completion flow updated to write to fingerprint_templates
